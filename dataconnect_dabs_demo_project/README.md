# dataconnect_dabs_demo_project

The 'dataconnect_dabs_demo_project' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dataconnect_dabs_demo_project_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/dataconnect_dabs_demo_project.job.yml). The schedule
